...
const Temperature = () => {
  ...
  return (
    <div className="min-h-screen health-gradient">
      <HealthNavigation showBackButton title="Temperature" />
      
      <div className="container mx-auto p-6">
        {/* Header with icon */}
        <div className="flex items-center justify-start mb-6">
          <div className="bg-medical-accent rounded-lg p-3 mr-4">
            <Thermometer className="h-8 w-8 text-medical-accent-foreground" />
          </div>
        </div>
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <YAxis 
                        ...
                        fontSize={12}
                        tick={{ fill: 'hsl(var(--foreground))' }}
                        label={{ value: 'Temperature (°C)', angle: -90, position: 'insideLeft', style: { textAnchor: 'middle', fill: 'hsl(var(--foreground))' } }}
                      />
                      <Tooltip 
                        contentStyle={{
                      ...
                      <Line
                        ...
                        activeDot={{ r: 6, stroke: "hsl(var(--health-danger))", strokeWidth: 2 }}
                      />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
