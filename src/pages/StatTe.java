...
public class StatTe extends JFrame {
    ...
    public StatTe() {
        ...
        // Fetch the data from the database (now using Tension)
        int[][] tensionData = getTensionDataFromDatabase(); // Fetch the 2D array of Tension values
        int numWeeks = tensionData.length; // Number of weeks
        ...
        for (int week = 0; week < numWeeks; week++) {
            ...
            for (int day = 0; day < 7; day++) {
                int barHeight = tensionData[week][day]; // Tension data for each day
                ...
                bar.setBackground(new Color(183, 53, 253)); // Bar color (you can change it as needed)
